      ...
      <main style={{ padding: "60px 24px" }}>
        ...
        <section style={{ maxWidth: "960px", margin: "0 auto 60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "32px" }}>
            {AUTHORS.map((author) => (
              <div key={author.name} style={{ background: "#0F172A", border: "1px solid #1E293B", borderTop: "4px solid #0EA5E9", borderRadius: "8px", padding: "32px", display: "flex", flexDirection: "column", gap: "16px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
                  <div style={{ width: "72px", height: "72px", borderRadius: "50%", overflow: "hidden", flexShrink: 0, border: "2px solid #0EA5E9" }}>
                  ...
                  <div>
                    ...
                    <h3 style={{ fontWeight: 800, fontSize: "22px", color: "#F8FAFC", margin: 0 }}>
                      {author.name}
                    </h3>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", gap: "16px" }}>
                  <a href={author.github} target="_blank" rel="noopener noreferrer" style={{ fontWeight: 700, fontSize: "14px", color: "#38BDF8", textDecoration: "none" }}>
                    GitHub &rarr;
                  </a>
                  {author.x && (
                    <a href={author.x} target="_blank" rel="noopener noreferrer" style={{ fontWeight: 700, fontSize: "14px", color: "#94A3B8", textDecoration: "none" }}>
                      X (Twitter) &rarr;
                    </a>
                  )}
                  {author.linkedin && (
                    <a href={author.linkedin} target="_blank" rel="noopener noreferrer" style={{ fontWeight: 700, fontSize: "14px", color: "#94A3B8", textDecoration: "none" }}>
                      LinkedIn &rarr;
                    </a>
                  )}
                </div>
        ...
        <section style={{ maxWidth: "960px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "24px" }}>
            {[
              { title: "GitHub Repository", body: "Inspect source code, submit bug reports, and create pull requests.", href: "https://github.com/Rahulchaube1/blyxxxx", linkLabel: "Visit Repository →", color: "#0EA5E9" },
              { title: "GitHub RFCs", body: "Propose language features, syntax changes, and compiler APIs.", href: "https://github.com/Blyx-lang-space/blyx/tree/blyx-main/RFC", linkLabel: "Browse RFCs →", color: "#38BDF8" },
              ...
              { title: "Security Disclosures", body: "Found a security vulnerability? Report it responsibly to the core team.", href: "/security", linkLabel: "Report Issue →", color: "#F59E0B" },
            ].map((card) => (
              <div key={card.title} style={{ padding: "28px", background: "#0F172A", border: "1px solid #1E293B", borderLeft: `4px solid ${card.color}`, borderRadius: "8px" }}>
