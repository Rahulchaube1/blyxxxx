...
export default function HomePage() {
  ...
  return (
    <FlowArt className="bg-[#0A0908] text-[#F0EDE8]">
      {/* Section 1: Hero & Quick Start */}
      <FlowSection className="bg-[#0A0908]">
        ...
        <div style={{
          ...
          maxWidth: '1200px',
          height: '600px',
          background: 'radial-gradient(ellipse at top, rgba(124, 58, 237, 0.22) 0%, rgba(6, 182, 212, 0.08) 50%, transparent 70%)',
          pointerEvents: 'none',
          zIndex: 0,
        }} />

        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{
            display: 'inline-flex',
            alignItems: 'center',
            gap: '8px',
      ...
      {/* Section 2: Code Showcase Terminal */}
      <FlowSection className="bg-[#0D0B12]">
        <div style={{ maxWidth: '860px', margin: '0 auto', width: '100%' }}>
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <h2 style={{ fontFamily: "'Inter', sans-serif", fontSize: '36px', fontWeight: 800, color: '#F0EDE8', marginBottom: '12px' }}>
              Native AI &amp; Tensor Syntax
            </h2>
            <p style={{ fontSize: '18px', color: '#9CA3AF' }}>
              Explore how Blyx seamlessly integrates LLM generation, chain-of-thought reasoning, and static tensors into standard language syntax.
            </p>
          </div>
      ...
      <FlowSection className="bg-[#0A0908]">
        <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
            <div style={{ background: '#121118', border: '1px solid rgba(124, 58, 237, 0.2)', borderRadius: '12px', padding: '28px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '10px', background: 'rgba(124, 58, 237, 0.2)', color: '#A78BFA', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px', marginBottom: '16px' }}>
                🧠
              </div>
              <h3 style={{ fontFamily: "'Inter', sans-serif", fontSize: '20px', fontWeight: 700, color: '#F0EDE8', marginBottom: '8px' }}>
                AI-First Primitives
              </h3>
