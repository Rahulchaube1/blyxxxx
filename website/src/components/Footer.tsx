      ...
      <div style={{
        ...
        <div>
          ...
          {[
            ...
            <Link key={href} href={href} style={{ display: "block", fontSize: "14px", color: "#9CA3AF", textDecoration: "none", marginBottom: "10px" }}>
              {label}
            </Link>
          ))}
        </div>
        ...
        <div>
          ...
          <a
            ...
            style={{ display: "inline-flex", alignItems: "center", gap: "8px", color: "#A78BFA", textDecoration: "none", fontWeight: 600, fontSize: "14px" }}
          >
